...
const prepareAnswers = async (submission: Submission, form_pk:number, setAnswersCB: (value:DisplayAnswer[])=> void) => {
...
export default function Answer(props: { submission: Submission, form_pk:number }) {
